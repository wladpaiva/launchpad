...
import '@repo/design-system/components/icons'

import {Gift} from '@repo/design-system/components/icons'
...
export function Hero() {
  return (
    <section className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 lg:items-start px-4 my-24 sm:my-32">
      <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-start">
        ...
        <h1 className="font-extrabold text-4xl lg:text-6xl tracking-tight md:-mb-4 flex flex-col gap-3 items-center lg:items-start">
          ...
          <span className="whitespace-nowrap relative ">
            ...
            <span className=" relative whitespace-nowrap">
              <span className="absolute bg-muted-foreground -left-2 -top-1 -bottom-1 -right-2 md:-left-3 md:-top-0 md:-bottom-0 md:-right-3 -rotate-1" />
              <span className="relative text-background">not weeks</span>
            </span>
          </span>
        </h1>
        ...
        <div className="space-y-4">
          <Button className="w-60" title="Go to Turboship Checkout">
            Get Turboship
          </Button>
          <p className="text-sm md:text-base flex justify-center items-center gap-2 md:text-sm">
            <Gift className="w-5 h-5 fill-accent animate-pulse" />{' '}
            <span>
              <span className="text-accent">$100 off</span> for the first 1570
              customers (9 left)
            </span>
          </p>
        </div>
        <div className="flex flex-col md:flex-row justify-center align-center gap-3">
          <div className="-space-x-5 avatar-group flex overflow-hidden justify-start">
            {avatars.map((avatar, i) => (
              <div key={i} className="avatar w-12 h-12">
                ...
                <img
                  ...
                  data-nimg={1}
                  src={avatar.imageUrl}
                  className="border-background border-4 rounded-full"
                />
              </div>
            ))}
          </div>
          <div className="flex flex-col justify-center items-center md:items-start gap-1">
            ...
            <div className="text-base text-base-content/80">
              <span className="font-semibold text-base-content">1561</span>{' '}
              makers ship faster
            </div>
          </div>
        </div>
      ...
      <div className="relative max-md:-m-4 lg:w-full">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          alt="Mongo + Mailgun + Stripe + NextJS + Tailwind + NextAuth = Turboship"
          width={1080}
          height={1080}
          decoding="async"
          data-nimg={1}
          className="w-full max-w-xl ml-auto"
          src="https://via.placeholder.com/1024?text=Placeholder+Image"
